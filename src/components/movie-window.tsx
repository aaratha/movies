...
export const Movie_window = ({ className }: Movie_windowProps) => {
    return (
        <div className=' lg:w-[14.28%] p-[0px] bg-gradient-to-r from-co2 to-grad rounded-lg mt-3 flex h-full flex-col'>
            <h1 className='ml-1 p-3 text-center text-black font-bold'>Similar Movies</h1>
            <div className=' scrollbar-none flex overflow-scroll lg:h-full flex-row lg:flex-col p-4 bg-co1  rounded-none rounded-b-lg lg:w-auto'>
                <Image
                    src={img}
