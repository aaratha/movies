            ...
            <div className=' rounded-lg p-2 bg-co1 flex flex-row justify-between pl-5 pr-3 items-center' style={{ width: '100%' }}>
                ...
                <div className='flex flex-row'>
                    <div className='flex bg-gradient-to-r from-co2 mr-3 to-grad rounded-full'>
                        <input type='text' className=' placeholder-black placeholder-opacity-50 bg-gradient-to-r from-co2 to-grad pl-4 m-[2px] w-[25vw] min-w-[150px] rounded-full p-1' placeholder='Enter Movie Title' />
                    </div>
