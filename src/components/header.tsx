...
export const Header = ({ }: HeaderProps) => { 
    ...
    return (
        <div className='nu rounded-lg p-[2px] bg-gradient-to-r from-co2 to-grad flex flex-row justify-between items-center' style={{ width: '100%' }}>
            <div className=' rounded-lg p-2 bg-co1 flex flex-row justify-between pl-4 pr-3 items-center' style={{ width: '100%' }}>
                    ...
                    <form className='flex flex-row' onSubmit={handleSearch}>
                        <div className='flex bg-gradient-to-r from-co2 mr-3 to-grad rounded-full'>
                            <input 
                                type='text' 
                                value={inputValue} 
                                className='relative placeholder-black placeholder-opacity-50 bg-gradient-to-r from-co2 to-grad pl-3 m-[2px] w-[30vw] min-w-[150px] rounded-full p-1 z-10'
                            ...
                            />
                            {isInputFocused && (
                                <div className={`h-40 overflow-scroll inputshadow absolute mt-5 w-[30.37vw] min-w-[150px] pt-7 p-4 bg-gradient-to-r from-co2 to-grad rounded-br-lg rounded-bl-lg z-1 text-black`} >
