            ...
            <div className=' flex flex-col h-full  rounded-lg'>
                <div className='justify-between nestflex flex flex-row pl-4 pr-4 p-1 rounded-xl items-center'>
                    ...
                    <div>
                        ...
                        <button className='but2 ml-2 p-1 pl-2 pr-2 scale-93 hover:pl-3 hover:pr-3 rounded-full border-2 text-black border-black hover:border-grad'>Academic</button>
                        <button className='but2 ml-2 mr-1 p-1 pl-2 pr-2 scale-93 hover:pl-3 hover:pr-3 rounded-full border-2 text-black border-black hover:border-grad'>Background</button>
                    </div>
                </div>
