...
export const Info_window = ({ className, selectedMovieID }: Info_windowProps) => {
    ...
    return (
        <div className='mt-3  lg:w-[42.86%] p-[0px] bg-gradient-to-r from-co2 to-grad rounded-lg justify-between flex-col flex'>
            <div className=' justify-between flex flex-col h-full p-3 bg-co1  rounded-lg'>
                <div>
