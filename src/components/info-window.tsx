...
export const Info_window = ({ className, selectedMovieID }: Info_windowProps) => {
    ...
    return (
        <div key={movieDescription} className='mt-6 nu lg:w-[42.86%] p-[2px] bg-gradient-to-r from-co2 to-grad rounded-lg justify-between flex-col flex'>
            <div className=' justify-between flex flex-col h-full p-4 bg-gradient-to-b from-bg2 to-gray-900 rounded-lg'>
                <div>
                    ...
                    <p key={movieDescription} className=''>
                        {movieDescription}
                ...
                <div className='mt-4'>
                    ...
                    <div className=' rounded-lg rounded-tl-none bg-gradient-to-r from-co2 to-grad p-[2px]'>
                        <div className=' overflow-x-scroll overflow-y-hidden nu-in rounded-lg p-3 bg-bg2 flex flex-row'>
